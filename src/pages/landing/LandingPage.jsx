...
export default function LandingPage() {
  ...
  return (
    <div className="wp4">
      ...
      {/* ───────────────────────── Panel / poranny raport ───────────────────────── */}
      <section className="wp4-section" id="panel">
        <div className="wp4-container wp4-preview">
          <div className="wp4-preview__copy">
            <span className="wp4-label">Panel · 06</span>
            <h2 className="wp4-h2">
              Poranny raport <em>w pięć sekund</em>
            </h2>
            <p className="wp4-body">
              Otwierasz aplikację przy kawie i od razu wiesz, co dzisiaj się
              dzieje: kto się melduje, kto wyjeżdża, co czeka na sprzątanie.
            </p>
            <ul className="wp4-checklist">
              <li>Wszystkie obiekty na jednym ekranie</li>
              <li>Gotowa lista zadań na dany dzień</li>
              <li>Statusy płatności i kanałów w jednym rzucie oka</li>
            </ul>
            <Link to="/login" className="wp4-link wp4-link--strong">
              Otwórz panel demo →
            </Link>
          ...
          <div className="wp4-preview__figure">
            <div className="wp4-graphpaper">
              <div className="wp4-graphpaper__row">
                <span className="wp4-tag wp4-tag--green">MELDUNEK · 15:00</span>
                <span className="wp4-label wp4-label--faint">Domek Ruś 1 · płatność OK</span>
              </div>
              <div className="wp4-graphpaper__row">
            ...
            <p className="wp4-fig">RYS. 2 — Plan dnia</p>
          </div>
        </div>
      </section>
