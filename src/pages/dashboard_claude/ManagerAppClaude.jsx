...
import {
  LayoutDashboard, CalendarDays, Building2, List, BarChart3,
...
export default function ManagerAppClaude() {
  ...
  const renderView = searchQuery && ['calendar', 'objects', 'finance', 'pulpit'].includes(activeView) ? 'bookings' : activeView;
