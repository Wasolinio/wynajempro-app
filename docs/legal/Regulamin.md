...
1. Aplikacja umożliwia Gospodarzowi w szczególności:
   ...
   - generowanie projektów umów najmu. **Generator umów udostępnia WZORCE robocze; nie stanowią one porady prawnej i przed użyciem wymagają samodzielnej weryfikacji przez Użytkownika, w razie potrzeby z pomocą prawnika. Operator nie odpowiada za skutki prawne zastosowania wygenerowanych wzorców.** *(Disclaimer wymagany — generator umów to funkcja wysokiego ryzyka prawnego. Ostateczne brzmienie do potwierdzenia z prawnikiem.)*
