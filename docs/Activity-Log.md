...
- 📌 **Wniosek metodologiczny**: deklaracja „e2e N/N" w commicie jest prawdziwa **wyłącznie w dniu commita**. Pełny przebieg suity pokazał też **52 zastane awarie** (guest-guide, stripe, ui-scaling, links-buttons) — sprawdzone kontrolnie na `git stash`, że są niezależne od dzisiejszych zmian; wymagają osobnego przeglądu.
