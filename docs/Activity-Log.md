...
- ⚖️ **Smoke test niepełny i tak zapisany**: procedura chce pary „jeden zapis przechodzi, jeden odrzucony". Zapis ze zgodą potwierdzi właściciel na produkcji (dokument sprawdzę przez MCP). **Odrzucenia nie da się zasymulować z mojej strony** — przeglądarka agenta nie przechodzi App Check, a kanał MCP jest tylko do odczytu. Negatywny przypadek pokrywa test e2e i treść samej reguły.
