...
### Smoke testy właściciela 4a–4e (część) + dwa znaleziska
...
- ⏸ **Zostaje z serii**: 4e w części „Raporty" (wydruk A4, eksport CSV — polskie znaki i przecinki dziesiętne) oraz **4f** (rejestracja + weryfikacja e-mail). 4f zyskał dziś nowe znaczenie: po odkryciu `ADMIN_ONLY_OPERATION` warto potwierdzić, że zakładanie kont w ogóle działa.
