# Rezerwacje, koszty i zadania

Wszystko, co dzieje się w Twoim wynajmie, zapisujesz w panelu jako wpisy jednego z trzech typów: „Rezerwacja", „Koszty" albo „Zadanie". Ten artykuł pokazuje, jak je dodawać, edytować i oznaczać jako opłacone lub wykonane.

## Dodawanie wpisu

1. Kliknij przycisk „Rezerwacja" (z ikoną plusa) w prawym górnym rogu panelu.
2. Otworzy się formularz „Nowy wpis" z trzema zakładkami typu: „Rezerwacja", „Koszty", „Zadanie".
3. Wybierz typ, uzupełnij pola i kliknij „Zapisz wpis".
4. Potwierdzeniem jest komunikat „Dodano pomyślnie!".

### Typ „Rezerwacja" — pobyt gościa
...
W tabeli „Rezerwacje" kolumna „Status" zawiera kółko przy każdej rezerwacji:
