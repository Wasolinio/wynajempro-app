...
### X15. Emotikony kategorii kosztów i źródeł rezerwacji (właściciel, 2026-07-15)
**Po co:** szybsza czytelność list. **Zakres:** więcej trafnych emotikonów przy kategoriach kosztów + aktualizacja emotikonów źródeł rezerwacji. **Uwaga kolejności:** robić PO partii kosztowej X4 (kategorie kosztów będą wtedy przemeblowane — uniknąć podwójnej roboty). **Agent:** `designer` + `dev`. ⬜
