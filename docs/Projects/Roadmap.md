...
- ⚖️ `legal` przeanalizował (2026-07-22, raport: [[Ocena-linki-guide-opinie]]): model „nieodgadywalny link" obronny jako fundament, ale 4 blokery przed launchem — m.in. token linku wycieka do GA (`AnalyticsTracker`), brak ostrzeżenia w GuideBuilderze, luka w Polityce/Regulaminie/DPA, powiązanie z N5 C.1. 5 decyzji u właściciela ([[Zlecenia-wlasciciela]]).
