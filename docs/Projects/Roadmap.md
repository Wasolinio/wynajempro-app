...
| **B5** | Warunki founding members w Regulaminie §6 — **w większości USTALONE** ([[Decisions]] ADR-016, 2026-08-22: cena startowa gwarantowana 12 mies., zmiana ceny z 30-dniowym wyprzedzeniem, bez kodu rabatowego). ⏸ Brakuje **jednej danej: daty zakończenia naboru** — ustalanej w dniu uruchomienia płatnej sprzedaży, czyli zależnej od wstrzymanej ścieżki A | przed pierwszym zaproszeniem |
...
- 🔴 **Czego to NIE zamyka — bramka publikacji stoi dalej i to nie jest formalność.** W dokumentach zostaje **36 placeholderów `[DO UZUPEŁNIENIA]`**: Regulamin 12, Polityka prywatności 16, DPA 8. Najważniejsze z nich to **tożsamość Operatora** (imię i nazwisko, adres do korespondencji, e-mail kontaktowy) — obowiązek z UŚUDE art. 5 i RODO art. 13, **niezależny od formy działalności**, więc działalność nierejestrowana go nie znosi. Do tego adres do reklamacji i odstąpienia oraz sposób udostępniania faktur. **Dokumentu z „[DO UZUPEŁNIENIA]" nie wolno opublikować** — akceptacja prawnika dotyczy treści, nie luk w niej.
