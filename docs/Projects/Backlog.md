...
- **Zadania w kalendarzu telefonu — subskrypcja z przypomnieniami** (2026-08-28, decyzja właściciela przy rozstrzyganiu zakresu E3): zakładka Zadania powstaje **bez eksportu**; jedyną formą eksportu wartą zrobienia byłaby integracja z kalendarzem w telefonie, żeby przy zadaniu dało się ustawić dodatkowe powiadomienie i przypomnienie. Naturalna ścieżka techniczna: kanał subskrypcyjny iCal na wzór istniejącego `exportIcal` (rezerwacje), z zadaniami jako zdarzeniami. ⚠️ Granica do zbadania, zanim cokolwiek obiecamy: subskrybowany kalendarz odświeża się w interwale narzuconym przez aplikację kalendarza (bywa raz na kilkanaście godzin), a przypomnienia zaszyte w pliku część aplikacji ignoruje — wtedy przypomnienie ustawia użytkownik na swoim kalendarzu, nie my. **Po co:** zadanie „posprzątać przed przyjazdem" ma przypominać o sobie tam, gdzie gospodarz patrzy — w telefonie, nie w panelu.
